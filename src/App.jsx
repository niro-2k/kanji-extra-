        ...
        >
          ...
          <div className="flex gap-3" style={{ height: 'calc(100% - 70px)' }}>
            ...
            <div className={`flex-1 ${hasKundoku ? 'pr-3 border-r' : ''} ${darkMode ? 'border-slate-700' : 'border-slate-200'}`}>
              {hasOndoku && (
                <>
                  <div className={`text-lg font-bold mb-2 ${darkMode ? 'text-rose-400' : 'text-rose-600'}`}>
                    {char.ondoku}
                  </div>
                  <div className={`pl-2 border-l-2 ${darkMode ? 'border-rose-400/50' : 'border-rose-200'}`}>
                    {char.ondokuEx?.slice(0, 2).map((ex, i) => (
                      <div key={i} className="py-1">
                        ...
                        <div className={`text-lg ${darkMode ? 'text-slate-400' : 'text-slate-600'}`}>{ex.meaning}</div>
                      </div>
                    ))}
                  </div>
                </>
            ...
            {hasKundoku && (
              <div className="flex-1">
                <div className={`text-lg font-bold mb-2 ${darkMode ? 'text-sky-400' : 'text-sky-600'}`}>
                  {char.kundoku}
                </div>
